...
#word
success = "\033[1;32mGITUWA\033[0m"
failed = "\033[1;31mHUJ\033[0m"
...
Autor : {}kubaaqx{}
Discord : {}https://discord.gg/qxcJ5Sa{}
...
def generate_token():
    ...
    print "[{}]{} Generuje token dostepu czekaj kurwa....".format(info,good)
    time.sleep(5)
    if len(username) == 0:
